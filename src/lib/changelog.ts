...
export const changelog: ChangelogEntry[] = [
  {
    ...
    agent: 'claude-code',
    summary: 'Sprint 3: Narratives Board — Notion-backed market narrative tracker with weekly scroll-lock list, zoomable heatmap/web view, pop-out sidebar, CRUD backend routes, frontend service, NavSidebar + TopHeader integration, Track skill prefix update.',
    files: [
      'backend-hono/src/services/narratives-service.ts',
      'backend-hono/src/routes/narratives/index.ts',
      'backend-hono/src/routes/index.ts',
      'frontend/lib/services.ts',
      'frontend/lib/layoutOrderStorage.ts',
      'frontend/lib/skillPrefixes.ts',
      'frontend/components/narratives/NarrativeCard.tsx',
      'frontend/components/narratives/NarrativeCreateModal.tsx',
      'frontend/components/narratives/NarrativesList.tsx',
      'frontend/components/narratives/NarrativesWeb.tsx',
      'frontend/components/narratives/NarrativesSidebar.tsx',
      'frontend/components/narratives/NarrativesPanel.tsx',
  ...
  },
  {
    ...
    agent: 'claude-code',
    summary: 'Sprint 2: Theme System — 6 presets (solvys-gold, ios, project-x, dark-trading, miami-heat, monocolor), CSS variable architecture, ThemeProvider context, ThemeSettings panel with live preview + custom HEX inputs, localStorage persistence. Migrated key components (ChatHeader, ChatGreeting, ChatMessageBubble, PulseThinkingIndicator, PulseSkillsPopup, NavSidebar, SettingsPanel, App scrollbars) to CSS variables.',
    files: [
