...
export const SKILL_PREFIXES: Record<string, string> = {
  brief: '[SKILL:BRIEF] Search the web for the latest information about the instrument mentioned, summarize findings, and interpret what it means for the user\'s position or thesis. Be concise and actionable.',
  validate: '[SKILL:VALIDATE] Act as Horace (risk validation). Analyze the validity of the user\'s thesis against: (1) current research narratives we\'re tracking, (2) memos we\'ve published, (3) current news via web search. Assess market risk and provide a confidence-weighted verdict.',
