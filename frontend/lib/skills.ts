...
export const SKILLS: readonly SkillDef[] = [
  ...
  { id: 'quick_pulse', label: 'QuickPulse', icon: Activity, color: 'var(--pulse-accent)', description: 'Chart screenshot analysis: bias, entries, stop, target', keywords: ['quick', 'pulse', 'chart', 'screenshot', 'snap'], mcpServers: ['playwright'] },
  ...
  { id: 'update_pulse', label: 'Update Pulse', icon: RefreshCw, color: '#38BDF8', description: 'Pull latest changes from repository and rebuild the app', keywords: ['update', 'pull', 'deploy', 'rebuild', 'upgrade'], mcpServers: [] },
] as const;
