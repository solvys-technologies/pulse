...
export default function SettingsModal({ onClose }: SettingsModalProps) {
  ...
  return (
    <div className={`fixed inset-0 z-50 flex items-center justify-center ${isClosing ? 'animate-fade-out-backdrop' : 'animate-fade-in-backdrop'}`}>
      ...
      <div className={`relative w-full max-w-2xl bg-[#0a0a00] border border-[#FFC038]/20 rounded-lg shadow-[0_0_24px_rgba(255,192,56,0.15)] mx-4 ${isClosing ? 'animate-fade-out' : 'animate-fade-in'}`}>
        <div className="flex items-center justify-between p-6 border-b border-zinc-900">
          <h2 className="text-lg font-medium text-[#FFC038] tracking-wider uppercase">Settings</h2>
          <button
            onClick={handleClose}
            ...
            <div className="bg-[#140a00] rounded-lg p-4 space-y-4">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                ...
                <div className="space-y-2 text-xs text-zinc-400">
                  ...
                  <div className="ml-3">
                    • <code className="text-[#FFC038]">ProjectXUsername</code> - Your TopStepX username
                  </div>
                  <div className="ml-3">
                    • <code className="text-[#FFC038]">ProjectXApiKey</code> - Your TopStepX API key
                  </div>
                </div>
