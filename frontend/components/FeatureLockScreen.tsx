...
export function FeatureLockScreen({
  ...
  return (
    <div className="relative bg-[var(--pulse-bg)] border border-[var(--pulse-accent)]/20 rounded-lg p-8 flex flex-col items-center justify-center min-h-[200px]">
      <div className="absolute inset-0 bg-black/50 backdrop-blur-sm rounded-lg" />
      <div className="relative z-10 flex flex-col items-center gap-4">
        <Lock className="w-12 h-12 text-[var(--pulse-accent)]/50" />
        <div className="text-center">
          <h3 className="text-lg font-semibold text-white mb-2">Feature Locked</h3>
          <p className="text-sm text-gray-400 mb-1">
            This feature requires <span className="text-[var(--pulse-accent)] font-semibold">{requiredTierName}</span> tier.
          </p>
          {currentTier && (
