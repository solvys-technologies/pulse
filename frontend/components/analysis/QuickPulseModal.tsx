...
export default function QuickPulseModal({ isOpen, onClose, onAnalysisComplete }: QuickPulseModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4">
            <div className="w-full max-w-lg bg-[var(--pulse-surface)] border border-[var(--pulse-accent)]/20 rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">

                {/* Header */}
                <div className="p-4 border-b border-[var(--pulse-accent)]/10 flex items-center justify-between bg-[var(--pulse-accent)]/5">
                    <div className="flex items-center gap-2 text-[var(--pulse-accent)]">
                ...
                <div className="p-6">
                    {!image ? (
                        <div
                            ...
                            className="border-2 border-dashed border-zinc-700 hover:border-[var(--pulse-accent)]/50 rounded-xl p-8 flex flex-col items-center justify-center gap-3 cursor-pointer transition-all hover:bg-[var(--pulse-accent)]/5 group"
                        >
                            <div className="w-12 h-12 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center group-hover:scale-110 transition-transform">
                                <Upload className="w-6 h-6 text-zinc-400 group-hover:text-[var(--pulse-accent)]" />
                            </div>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <button
                                    ...
                                    disabled={loading}
                                    className="px-6 py-2 bg-[var(--pulse-accent)] hover:bg-[#FFD060] text-black font-semibold rounded-lg text-sm flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-[0_0_15px_rgba(255,192,56,0.3)] hover:shadow-[0_0_20px_rgba(255,192,56,0.5)]"
                                >
                                    {loading ? (
                                        <>
