...
export function McpConnectorPopup({ open, servers, activeIds, onToggle, onClose }: McpConnectorPopupProps) {
  ...
  return (
    <div
      className="w-full overflow-hidden rounded-xl border border-[#c79f4a]/20 transition-all duration-200"
      style={{
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-2 border-b border-[#c79f4a]/10">
        <div className="flex items-center gap-1.5">
          <Plug2 size={12} className="text-[#c79f4a]/70" />
          ...
          Object.entries(grouped).map(([category, items]) => (
            <div key={category}>
              ...
              <div className="px-3 pt-2.5 pb-1">
                <span className="text-[10px] font-semibold uppercase tracking-widest text-[#c79f4a]/40">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5 mb-0.5">
                        <span className="text-[12px] font-semibold text-[#f0ead6] truncate">{server.name}</span>
      ...
      {/* Footer */}
      {servers.length > 0 && (
        <div className="px-3 py-2 border-t border-[#c79f4a]/10 flex items-center justify-between">
