// [claude-code 2026-03-11] Track 7A: Human psych tab — ER trend, infractions, discipline score
import { useState, useEffect } from 'react';
import { TrendingDown, AlertTriangle, Shield, Save } from 'lucide-react';
    ...
    <div className="space-y-4">
      ...
      <div className="bg-[var(--pulse-surface)] border border-[var(--pulse-accent)]/10 rounded-lg p-3">
        ...
        <button
          ...
          disabled={saving}
          className="mt-2 flex items-center gap-1.5 px-3 py-1.5 text-[11px] font-medium bg-[var(--pulse-accent)] text-black rounded hover:brightness-110 active:scale-95 transition-all disabled:opacity-50"
        >
